...
const AccentSelect = (props: AccentSelectProps) => {
  ...
  const LANGUAGES = [
    {
      ...
      label: (
        <div className="flex">
          <Image className={flagStyle} src="/assets/img/vi.png" alt="vi" />
          <span>{t("vi")}</span>
        </div>
      ),
      value: "VI",
    },
    {
      ...
      label: (
        <div className="flex">
          <Image className={flagStyle} src="/assets/img/kr.png" alt="kr" />
          <span>{t("kr")}</span>
        </div>
      ),
      value: "KOR",
    },
    {
      ...
      label: (
        <div className="flex">
          <Image className={flagStyle} src="/assets/img/jp.png" alt="jp" />
          <span>{t("jp")}</span>
        </div>
      ),
      value: "JAP",
  ...
  return (
    <div className={cx("flex flex-wrap space-x-2 text-sm", props.className)}>
      {width < 640 ? (
        <Select.Root
          open={openEnglishSelect}
          onOpenChange={(open) => setOpenEnglishSelect(open)}
        >
          <Select.Trigger asChild>
            <div className={cx("flex items-center", itemStyle)}>
        ...
        <>
            ...
            <Select.Trigger asChild>
              <div
                className={cx(
                  ...
                  itemStyle,
                  ENGLISH.some(
                    (accent) => accent.code === selectedLanguage.code
                  )
                    ? activeItemStyle
                    : null
                )}
          ...
          {LANGUAGES.map((language) => (
            <div
              ...
              className={cx(
                itemStyle,
                selectedLanguage.code === language.code ? activeItemStyle : null
              )}
